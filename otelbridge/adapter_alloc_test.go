...
var allocBudget = []struct {
	...
	{"16 fields (common staging capacity)", func() *types.LogEntry { return entryWith(16) }, 1},
	{"17 fields (wide staging begins)", func() *types.LogEntry { return entryWith(17) }, 1},
	{"32 fields (wide staging capacity)", func() *types.LogEntry { return entryWith(32) }, 1},
	{"33 fields (bounded staging spill)", func() *types.LogEntry { return entryWith(33) }, 2},
